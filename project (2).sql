...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2022 at 10:30 AM
...
CREATE TABLE `category` (
  ...
  `category_detail` varchar(255) NOT NULL COMMENT 'คำอธิบายหมวดหมู่'
...
(1, 'ยาสามัญประจำบ้าน\r\n', 'HOUSEHOLD'),
(2, 'ยาบรรจุเสร็จ', 'NONPRESCRIPTION'),
(3, 'ยาอันตราย', 'PRESCRIPTION'),
(4, 'ยาควบคุมพิเศษ', 'RESTRICT'),
(5, 'สมุนไพร / แผนโบราณ', 'HERBAL'),
(6, 'เวชภัณฑ์ / เครื่องมือแพทย์', 'MEDICAL SUPPLIES / EQUIPMENT'),
(7, 'เครื่องสำอาง / ผลิตภัณฑ์บำรุงผิว', 'COSMETICS'),
(11, 'วิตามิน / อาหารเสริม', ''),
(12, 'ยาใช้ภายนอก', 'DRUG FOR EXTERNAL USE');
...
CREATE TABLE `contact` (
  ...
  `contact_province` varchar(300) NOT NULL,
  `contact_amphures` varchar(300) NOT NULL,
  `contact_geo` varchar(300) NOT NULL,
  `contact_zip` varchar(300) NOT NULL,
  `contact_number` varchar(300) NOT NULL,
  `contact_img` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `contact` (`contact_id`, `contact_name`, `contact_phone`, `contact_email`, `contact_add`, `contact_province`, `contact_amphures`, `contact_geo`, `contact_zip`, `contact_number`, `contact_img`) VALUES
(19, 'พาราเซตามอล จำกัด', '0844446328', '-', '44/123', '13', '164', '220509', '11550', '1104300240006', 'kisspng-computer-icons-man-clip-art-icon-orang-5b4d814b19c7d1.4051447715318060271056.jpg'),
(21, 'ดาชัย์1', '0644441185', '-', '56/52', '18', '213', '270802', '11320', '6889522074', 'download.png');
...
CREATE TABLE `customer` (
  ...
  `customer_img` varchar(300) NOT NULL,
  `customer_type` varchar(300) NOT NULL,
  `customer_add` varchar(255) NOT NULL,
  `customer_province` varchar(300) NOT NULL,
  `customer_amphures` varchar(300) NOT NULL,
  `customer_geo` varchar(300) NOT NULL,
  `customer_zip` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `customer` (`customer_id`, `customer_name`, `customer_phone`, `customer_email`, `customer_img`, `customer_type`, `customer_add`, `customer_province`, `customer_amphures`, `customer_geo`, `customer_zip`) VALUES
(612265, 'นาย อรรฆพล จิตรักมั่น', '0641318526', '-', 'download (1).png', '2', 'อุตสาหกรรมนวนคร1', '4', '67', '130201', '11220');
...
--
-- Table structure for table `doc_unit`
--

CREATE TABLE `doc_unit` (
  `dunit_id` int(255) NOT NULL,
  `product_id` int(11) NOT NULL,
  `unit_id` varchar(300) NOT NULL,
  `dunit_price` varchar(300) NOT NULL,
  `dunit_sale` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `doc_unit`
--

INSERT INTO `doc_unit` (`dunit_id`, `product_id`, `unit_id`, `dunit_price`, `dunit_sale`) VALUES
(84, 84, '1', '90', '100'),
(85, 85, '6', '100', '120'),
(86, 86, '6', '300', '320'),
(87, 87, '3', '200', '250'),
...
CREATE TABLE `good` (
  ...
  `good_reference` varchar(300) NOT NULL,
  `good_date` varchar(300) NOT NULL,
  `good_import` varchar(255) NOT NULL,
  `good_contact_order` varchar(255) NOT NULL,
  `good_contact_sale` varchar(255) NOT NULL,
  `product_id` varchar(255) NOT NULL,
  `good_product_start` varchar(300) NOT NULL,
  `good_product_end` varchar(300) NOT NULL,
  `good_qty` varchar(255) NOT NULL,
  `good_product_total` varchar(300) NOT NULL,
  `good_vat` varchar(300) NOT NULL,
  `good_sum` varchar(300) NOT NULL,
  `good_total` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `po` (
  ...
  `po_reference` varchar(300) NOT NULL,
  `po_date` varchar(300) NOT NULL,
  `po_contact_order` varchar(30) NOT NULL,
  `po_contact_sale` varchar(300) NOT NULL,
  `product_id` varchar(300) NOT NULL,
  `po_product_start` varchar(300) NOT NULL COMMENT 'วันที่ผลิต',
  `po_product_end` varchar(300) NOT NULL,
  `po_qty` varchar(300) NOT NULL COMMENT 'จำนวนสินค้า',
  `po_product_total` varchar(300) NOT NULL,
  `po_vat` varchar(300) NOT NULL,
  `po_sum` varchar(300) NOT NULL,
  `po_total` varchar(255) NOT NULL COMMENT 'ราคาสุทธิ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `product` (
  ...
  `product_net` varchar(300) NOT NULL,
  `product_detail` varchar(300) NOT NULL,
  `product_type` varchar(300) NOT NULL COMMENT 'ประเภทสินค้า PK\r\n',
  `product_category` varchar(255) NOT NULL COMMENT 'หมวดหมู่สินค้า pk',
  `product_symptom` varchar(255) NOT NULL COMMENT 'หมวดหมู่อาการ pk',
...
INSERT INTO `product` (`product_id`, `product_name`, `product_generic`, `product_net`, `product_detail`, `product_type`, `product_category`, `product_symptom`, `product_img`) VALUES
(84, 'กรดพาราอะมิโนเบนโซอิก', 'Para-Aminobenzoic Acid', '0', 'เป็นวิตามินบีชนิดหนึ่ง ละลายในน้ำ สามารถพบได้ในกรดโฟลิก และในอาหาร เช่น ธัญพืช ไข่ นม เนื้อสัตว์ เครื่องในสัตว์ มีคุณสมบัติเป็นสารต้านอนุมุลอิสระ มีส่วนช่วยในการสร้างกรดโฟลิก การดูดซึมวิตามินบี 5 และการใช้โปรตีนของร่างกาย', '2', '1', '1', 'กรดพาราอะมิโนเบนโซอิก.png'),
(85, 'Dettol ผ้าเช็ดทำความสะอาดผิวมือแบบเปียก', '-', '0', 'ผ้าเช็ดทำความสะอาดผิวมือแบบเปียก จำนวน 50 ชิ้น พกพาง่าย ทำความสะอาด ลดเชื้อโรคและถนอมผิว', '3', '12', '1', '_-5_1.jpg'),
(86, 'Medigrip ผ้ารัดหน้าท้อง Abdominal Support Size M', '-', '0', 'ผ้ายืดรัดหน้าท้อง Support Size M อุปกรณ์ป้องกันและบรรเทาอาการปวดหลังขณะยืน หรือนั่งขับรถเป็นเวลานาน ๆ ลดการเกิดแผลนูนหลังการผ่าตัดหน้าท้อง ช่วยให้หนังหน้าท้องที่ย้วย หย่อนยาน คืนรูปและกลับมากระชับได้เร็วยิ่งขึ้น', '3', '6', '1', '118249-1.png'),
(87, 'Herbal One Sesamin สารสกัดงาดำ 200g.', '-', '0', 'สารสกัดงาดำชนิดแคปซูล เสริมสร้างมวลกระดูกให้แข็งแรง อีกทั้งยังช่วยต้านอนุมูลอิสระและชะลอการเสื่อมของเซลล์', '2', '1', '1', '230936_1.jpg'),
(88, 'เทปปิดแผลชนิดใส HOF CARE เทปใส 1/2\"X10 หลา', '-', '0', 'HB เทปปิดแผลชนิดใส HOF CARE 1/2\"X10 หลา กล่อง 24 ชิ้น เทปแต่งแผลชนิดใส ระบายอากาศได้ดี กาวไฮโปอัลเลอจินิกไม่ระคายเคืองผิว เทปแต่งแผลชนิดใส ระบายอากาศได้ดี ฉีกได้ทั้งแนวตั้งและแนวนอน กาวไฮโปอัลเลอจินิก ไม่ระคายเคืองผิว ขนาด 1/2 นิ้ว x10 หลา', '3', '1', '1', '246859_1.jpg'),
(89, 'อ้วยอัน Mr.herb ยาน้ำแก้ไอเด็ก 60 มล.', '-', '0', '-', '3', '11', '1', '238244-1.png'),
(90, 'Flemomile Mouth Spray สเปรย์สำหรับช่องปาก', '', '0', '', '3', '1', '1', '].jpg'),
(91, 'SARA ซาร่า พาราเซตามอล เม็ดรี 500 มิลลิกรัม แผงละ 10 เม็ด', '', '0', '', '2', '1', '1', '298948_1.jpg'),
(92, 'Gaviscon กาวิสคอนซัสเพนชั่นเปปเปอร์มิ้นต์ ชนิดน้ำ', '-', '0', '-', '3', '1', '1', '265306_1.jpg'),
(93, ' บีแพนเธน เฟิร์สเอดครีม', '', '0', '', '2', '1', '1', '159271_1.jpg'),
(95, 'ยาบรรเทาริดสีดวง', '', '0', '', '2', '5', '1', '1652674781af328fa9017718a77c50dd422153ae56.jpg'),
(98, 'HIVAN สำลีก้านฆ่าเชื้อ ขนาด 6 นิ้ว ไซส์ L แพ็ค 100 ก้าน', '', '0', 'HI-VAN สำลีก้านฆ่าเชื้อ ขนาด 6\" ใช้เช็ดทำความสะอาดแผล สำลีก้านฆ่าเชื้อ ผ่านกรรมวิธีทันสมัย เพื่อให้ได้สำลีสะอาด บริสุทธิ์ นุ่มนวล ปลอดภัย ไม่เป็นขุย และซึมซับได้ดี', '3', '1', '2', '023531_1.jpg'),
(99, 'ผ้าก๊อซ GAUZE SPONGE 3\"X3\" จำนวน 100 ชิ้น', '', '0', 'ผ้าก๊อซ GAUZE SPONGE 3\"X3\" จำนวน 100 ชิ้น ผ้าก๊อซสำหรับใช้ทางการแพทย์ ขนาด 3x3 นิ้ว ใช้ทำแผล ปิดแผล สะอาด ปลอดภัย ไม่แสบแผล ป้องกันการติดเชื้อ ซับเลือดได้ดี เนื้อผ้าไม่ติดแผล สำหรับปฐมพยาบาลเบื้องต้น', '5', '1', '8', '020907_1.jpg'),
(100, 'SOS ผ้าก๊อซพร้อมใช้ PLUS S3 6 X 10CM 4 ชิ้น/แพ็ค', '', '0', 'SOS ผ้าก๊อซพร้อมใช้ PLUS S3 6 X 10CM 4 ชิ้น/แพ็ค ผ้าก๊อซปิดแผลแนบพร้อมใช้ เหมาะสำหรับแผลไม่เกิน 6 ซม. แผลสด แผลหกล้ม ถลอก แผลผ่าตัด แผลกดทับ หรือผู้ที่ต้องทำแผลบ่อยๆ แผ่นดูดซับไม่ติดแผล', '2', '1', '8', '201308_1.jpg'),
(101, 'อ้วยอัน ยาอมสมุนไพร รสฟ้าทะลายโจร 100 เม็ด', '', '0', 'ช่วยลดอาการอักเสบคอ คอแดงได้ดี ไม่ขม รสอร่อย บรรเทาอาการไอ ขับเสมหะ ช่วยให้ชุ่มคอ', '4', '5', '2', '223484-1.png'),
(102, 'อ้วยอัน Mr.herb ยาน้ำแก้ไอเด็ก 60 มล.', '', '0', 'อ้วยอัน MR.HERB ยาน้ำแก้ไอเด็ก 60 มล. บรรเทาอาการไอ ขับเสมหะ ช่วยให้ชุ่มคอ ใช้ในเด็กและผู้ใหญ่ก็ได้ ไม่มีส่วนผสมแอลกอฮอล์ เป็นยาแก้ไอไม่มีสารเคมีหรือแต่งกลิ่นเพิ่มเติม รสธรรมชาติสมุนไพร ทานง่าย อร่อย', '2', '1', '2', '1656039045238244-1.png'),
(103, 'เตียงไฟฟ้า 2 ไกร์ SLD-A21-111 ราวสไลด์ พร้อมที่นอน', '', '0', 'เตียงไฟฟ้า 2 ไกร์ พร้อมที่นอน ขนาดกะทัดรัด ดีไซน์ทันสมัย สามารถเคลื่อนย้ายและใช้งานง่าย ควบคุมการทำงานด้วยรีโมทคอนโทรล รองรับน้ำหนักได้สูงสุด 235 กิโลกรัม', '1', '6', '5', '246883-1.jpg'),
(104, 'Tigerplast Ankle Extra Comfort Support  อุปกรณ์ช่วยพยุงข้อเท้า สีเทา size S Tigerplast Ankle Extra Comfort Support  อุปกรณ์ช่วยพยุงข้อเท้า สีเทา size S Tigerplast Ankle Extra Comfort Support  อุปกรณ์ช่วยพยุงข้อเท้า สีเทา size S   Tigerplast Ankle Extra Comfort Support อุปกรณ์ช่วยพยุงข้อเท้า สีเทา si', '', '0', 'อุปกรณ์พยุงข้อเท้าช่วยรักษาสภาพข้อเท้าที่บาดเจ็บ บวม หรือบรรเทาอาการปวดบริเวณข้อเท้า', '3', '6', '5', '263778_2.jpg'),
(105, 'Sebamed Baby Lotion 200 ml.', '', '0', '', '5', '7', '11', '258618_1.jpg'),
(106, 'BIOLAND เครื่องวัดไข้ แบบอินฟราเรด ดิจิตอล รุ่น E122', '', '0', 'เครื่องสามารถวัดได้ดีที่อุณหภูมิโดยรอบที่ 15-40องศา ซึ่งเหมาะกับอากาศร้อนแบบประเทศไทย ทำให้ค่าที่วัดมีความถูกต้องน่าเชื่อถือกว่าแบบที่มีช่วงการทำงานที่อุณหภูมิต่ำ', '3', '6', '2', '270040_1.jpg'),
(107, 'Siaminnovation เทอร์โมมิเตอร์อินฟาเรด K3 + ขาตั้ง SET', '', '0', 'ใช้งานง่าย โดยไม่ต้องปรับตั้งค่า  ระยะเวลาตอบสนองเพียง 0.5 วินาที\r\n\r\n**ไม่มี Batteryในกล่อง', '1', '6', '2', '279161_1.jpg');
...
CREATE TABLE `store` (
  ...
  `store_number` varchar(300) NOT NULL,
  `store_status` varchar(300) NOT NULL,
  `product_id` varchar(255) NOT NULL,
  `store_date` varchar(255) NOT NULL,
  `store_customer` varchar(255) NOT NULL,
  `store_get` varchar(255) NOT NULL COMMENT 'รับเงินมา',
  `store_qty` varchar(300) NOT NULL COMMENT 'จำนวน',
  `store_product_total` varchar(300) NOT NULL,
  `store_total` varchar(300) NOT NULL COMMENT 'ราคารวม',
  `store_change` varchar(255) NOT NULL COMMENT 'เงินทอน\r\n'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'ทางเดินอาหาร'),
(2, 'หู คอ จมูก และช่องปาก'),
(3, 'มะเร็งและยากดภูมิคุ้มกัน'),
(4, 'ยาดมสลบ\r\n'),
(5, 'ระบบสูตินารีเวช\r\n'),
(6, 'ตา'),
(7, 'ระบบทางเดินหายใจ\r\n'),
(8, 'ผิวหนัง'),
(9, 'ยาปฏิชีวนะและฆ่าเชื้อ'),
(10, 'ระบบประสาท'),
(11, 'สารอาหาร');
...
CREATE TABLE `type_customer` (
  `typec_id` int(255) NOT NULL,
  `typec_name` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `type_customer` (`typec_id`, `typec_name`) VALUES
(1, 'ลูกค้าทั่วไป'),
(2, 'ลูกค้าประจำ');
...
CREATE TABLE `user` (
  ...
  `user_date` varchar(300) NOT NULL,
...
INSERT INTO `user` (`user_id`, `user_name`, `username`, `password`, `user_date`, `user_phone`, `user_img`, `user_status`) VALUES
(31126, 'ping', 'ppp', '1234', '2022-06-01', '0845562134', '', 'ผู้ดูแลระบบ'),
(61122, 'Anuwat', 'phar', '1234', '1 มกราคม 2513', '0641318526', 'file.png', 'เภสัชกร');
...
--
-- Indexes for table `doc_unit`
--
ALTER TABLE `doc_unit`
  ADD PRIMARY KEY (`dunit_id`);
...
--
ALTER TABLE `customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=612266;

--
-- AUTO_INCREMENT for table `doc_unit`
--
ALTER TABLE `doc_unit`
  MODIFY `dunit_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
--
ALTER TABLE `good`
  MODIFY `good_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200;

--
-- AUTO_INCREMENT for table `po`
--
ALTER TABLE `po`
  MODIFY `po_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=174;

--
-- AUTO_INCREMENT for table `product`
--
ALTER TABLE `product`
  MODIFY `product_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
...
--
ALTER TABLE `store`
  MODIFY `store_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `type_customer`
  MODIFY `typec_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `user`
  MODIFY `user_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61128;
COMMIT;
