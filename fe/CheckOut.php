...
<body>
    ...
    <div id="noaddress" style="display:none;">0</div> <?php }else{ ?> <div id="noaddress" style="display:none;">1</div>
    <?php  }?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="container my-button22" id="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="shoping__checkout">
                                <a onclick="history.back()" class="text-white main-btn primary-btndet m-2"><i
                                        class="fa fa-arrow-left" aria-hidden="true"></i> BACK </a>
                                <a id="insert_to_purchase" class="text-white main-btn primary-btnpri m-2"> <i
            ...
            <div class="col-md-5">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                                 $totall = 0 ;            
                                 $pricee = 0 ;
                                     $sql = "SELECT  quantity , prod_name , sprod_name ,  sprodone_name , prod_price_simple , message  FROM akksofttech_cart  INNER JOIN akksofttech_member_store 
                                     ON akksofttech_cart.sto_id = akksofttech_member_store.sto_id 
                                      WHERE cus_id = '".$_SESSION['akksofttechsess_cusid']."'  " ;                           
                                     $query = mysqli_query($conn , $sql) ;   
                ...
                <td><strong> £
                        <?php echo  number_format($result['prod_price_simple'] * $result['quantity'],2,'.',',') ; ?></strong>
                </td>
                </tr>
                ...
                <div class="row mb-5">
                    <div class="col-lg-12">
                        <div class="shoping__checkout">
                            <ul>
                                <li class="mx-2"> TOTAL <span> £
                                        <?php echo number_format($pricee,2,'.',',') ; ?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form method="post" id="insert_address1">
                    <div class="modal-body">
                                ...
                                <div class="single-form form-default">
                                    <div class="form-input">
                                        <input type="text" class="form-control" autocomplete="off" required
                                            ...
                                            oninput="this.setCustomValidity('')" placeholder="Phone" name="cusa_phone"
                                            id="cusa_phone">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="single-form form-default">
                                    <div class="form-input">
                                        <input type="text" class="form-control" autocomplete="off" placeholder="Note"
                                            name="cusa_note" id="cusa_note">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <div class="row mb-3">
                            <div class="col">
                                <div type="button" class="main-btn primary-btndet" onclick="history.back()">EXIT</div>
                            </div>
                            <div class="col">
