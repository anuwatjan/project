<?php 
   ...
   while($data = mysqli_fetch_array($query,MYSQLI_BOTH))	{
    ...
    $arrayBill = array( 
                        ...
                        "sprod_name" => $data['sprod_name'] <> "-" && $data['sprodone_name'] == "-"  ?  "<br>".$c." ".$data['sprod_name'] : $b , 
                        "sprodone_name" => $data['sprodone_name'] <> "-" && $data['sprod_name'] <> "-"  ? "<br>".$c." ".$data['sprod_name']."<br>".$c." ".$data['sprodone_name']  :  $b , 
