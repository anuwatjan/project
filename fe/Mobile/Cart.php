...
<div class="modal fade modal-fullscreen" id="Cart_Detail_Mobile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog3" role="document">
        ...
        <button type="button" id="checkout1" class="main-btn primary-btn" style="height:10%;border:none;"> GO TO CHECKOUT </button>
