        ...
        <form method='post' id='emp-UpdateForm' action="#">
            ...
            <div class="col-md-6 mb-2">
                <div class="single-form form-default">
                    ...
                    <div class="form-input">
                        <input type="text" class="form-control" autocomplete="off" placeholder="Full Name" required
            ...
            <div class="col-md-6 mb-2">
                <div class="single-form form-default">
                    ...
                    <div class="form-input">
                        <input type="text" class="form-control" autocomplete="off" placeholder="Sur Name" required
