$(document).ready(function () {
  ...
  // กดปุ่มล็อคอินแล้วไปฟังก์ชั่น checkout
  $("#ok_login_checkout").click(function (e) {
    e.preventDefault();
    var urls = "CheckOut.php";
    logins_checkout(urls);
  });

  // ฟังก์ชั่นตรวจสอบการล็อคอิน checkout
  function logins_checkout(urls) {
    var cus_username = $("#cus_username").val();
    var cus_password = $(".cus_password").val();
    if (cus_username != "" && cus_password != "") {
      console.log(cus_username + cus_password);
