      ...
      <div class="layout-container">
         ...
         <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
               <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">DELIVERY COMPLETED</span></h4>
               <div class="row">
                  <div class="col-md-12">
                ...
                <div class="col">
                  <div class="card mb-4">
                    ...
                    <?php
                      ...
                      WHERE sto_id = '".$_SESSION['akksofttechsess_stoid']."' AND po_status = 5"  ;
                                    ...
                                    <td style="text-align:center;">
                                      ...
                                      <?php }   ?>
                                       ...
                                       <?php 
                                        ...
                                        if($row['po_status'] == 5 &&  $rowpay['pay_cus_id'] == 0){
