              ...
              <div class="app-brand justify-content-center">
                <a href="" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                   <img src="assets/img/icons/AKK/logoAKK2.png" width="40px;" >
                      <defs>
                        <path
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">AKK SOFTTECH</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to E-commerce! </h4>
              <p class="mb-4">Please sign-in to your account and start here.</p>
...
$(document).ready(function() {
    ...
    function logins(urls) {
        ...
        console.log(mem_username + ' ' + mem_password);

        if (mem_username != "" && mem_password != "") {

            $.post("logincheck.php" , { mem_username : mem_username , mem_password : mem_password } , function(response) {
