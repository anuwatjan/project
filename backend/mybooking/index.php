        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                                                ...
                                                <div class="demo-inline-spacing mt-3">
                                                    <div class="list-group list-group-horizontal-md text-md-center">
                                                        ...
                                                        <a class="list-group-item list-group-item-action"
                                                            href="form_checkin.php">CHECK IN</a>
                                                        <a class="list-group-item list-group-item-action"
                                                            href="form_checkout.php">CHECK OUT</a>
                                                        <a class="list-group-item list-group-item-action"
                                                            href="form_cancel.php">CANCEL</a>
                                                                    ...
                                                                    <table class="table table-borderless" id="myTable">
                                                                        ...
                                                                        <thead class="table-primary">
                                                                            <tr>
                                                                                ...
                                                                                <th style="text-align:center;">pax
                                                                                </th>
                    ...
                    AND res_datereserve BETWEEN '".$_GET['stasdate']."'  AND '".$_GET['stopdate']."'   
                    ...
                    ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align:center;">
                                                                                    <?php echo $row['cus_name'];?></td>
                                                                                <td style="text-align:center;">
                                                                                    <?php echo $row['res_phone'];?></td>
                                                                                <td style="text-align:center;">
                                                                                    <?php echo $row['res_note'];?></td>
                                                                                <td style="text-align:center;"><a
                                                                                        type="button" href="#"
                                                                                        id="<?php echo $row['res_id']; ?>"
                                                                                        class="btn btn-outline-warning checkin">CHECK
                                                                                        IN</a>
                                                                                   

                                                                                        <a type="button" href="#"
                                                                                        id="<?php echo $row['res_id']; ?>"
                                                                                        class="btn btn-outline-danger cancel">CANCEL</a>

                                                                                    <a type="button"
                                                                                        href="add_form.php?id=<?php echo $row['res_id']; ?>"
