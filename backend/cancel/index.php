        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">CANCEL</span></h4>
                    <div class="row">
                        <div class="col-md-12">
                  ...
                  WHERE sto_id = '".$_SESSION['akksofttechsess_stoid']."' AND po_status = 6" ;
              ...
              ?>
                    ...
                    ?>
                                      ...
                                      $totoprice = 0 ; 
                                        ...
                                        if($row['po_status'] == 6 &&  $rowpay['pay_cus_id'] == 0){
