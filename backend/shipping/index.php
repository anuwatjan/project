                ...
                <div class="col">
                  <div class="card mb-4">
                    ...
                    <?php
                      ...
                      WHERE sto_id = '".$_SESSION['akksofttechsess_stoid']."' AND po_status = 4"  ;
                                    ...
                                    <td style="text-align:center;">
                                      ...
                                      <?php }   ?>
                                       ...
                                       <?php 
                                        ...
                                        if($row['po_status'] == 4 &&  $rowpay['pay_cus_id'] == 0){
                                      ...
                                      <td style="text-align:center;">
                                      <a type="button" href="#" id="<?php echo $row['po_id']; ?>" class="btn btn-outline-info completed">CONFIRM DELIVERING</a>
