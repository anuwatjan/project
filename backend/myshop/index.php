                            ...
                            <div class="row">
                                <div class="col-xl">
                                    <div class="card mb-4">
                                        ...
                                        <a type="button" href="index2.php" class="btn btn-primary">EDIT</a>
                                        </div>
                                        ...
                                        ?>   
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" readonly="readonly" class="form-control" name="sto_name"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" readonly="readonly" class="form-control" name="sto_address"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10"> 
                                                    <input type="text" readonly="readonly" class="form-control" name="sto_province"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">         
                                                    <input type="text" readonly="readonly" class="form-control" name="sto_zipcode"
