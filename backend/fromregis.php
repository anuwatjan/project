...
>
  <head>
    ...
    <script type="text/javascript" src="inesetregis.js"></script>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Get starts here</h4>
              <p class="mb-4">Create your account!</p>

              <form  class="mb-3" method='post' id='emp-SaveForm1' action="#">
                ...
                <button type="submit"  class="btn btn-primary d-grid w-100"  name="btn-save" id="btn-save">Sign up</button>
              </form>
