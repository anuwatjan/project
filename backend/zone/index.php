                            ...
                            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                <li class="nav-item">
                                    <a type="button" class="btn btn-success" id="btn-add" href="add_form.php"><i
                                            class="bx bx-plus"></i> ADD ZONE</a>
                                </li>
                                <li class="nav-item">
                                    <a type="button" class="btn btn-primary" id="btn-view" href="#"><i
                                            class="bx bx-show-alt"></i> VIEW ZONE</a>
                                </li>
                            </ul>
                                ...
                                <div class="table-responsive text-nowrap">
                                    <div class="content-loader">
                                        <table class="table table-borderless" id="myTable">
                                            <thead>
                                                <tr>
                                                    <th style="text-align:center;">ID ZONE</th>
                                          ...
                                          $sql ="SELECT * FROM akksofttech_tablezone WHERE sto_id = '".$_SESSION['akksofttechsess_stoid']."'" ;
                                    ...
                                    ?>
                                                <tr>
                                                    <td style="text-align:center;"># <?php echo $row['zone_id']; ?></td>
                                                    ...
                                                    <td style="text-align:center;">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a href="add_form.php?id=<?php echo $row['zone_id']; ?>"
                                                                class="dropdown-item" title="Edit"><i
                                                                class="bx bx-edit-alt me-1"></i> EDIT</a>
                                                                <a class="delete dropdown-item"
                                                                id="<?php echo $row['zone_id']; ?>" href="#"><i
