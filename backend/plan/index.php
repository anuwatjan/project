...
require_once '../include/condb.php';
    ...
    $rchart = mysqli_query($connect,$schart) or die ("error ".mysqli_error($connect));
        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">MY PLAN</span></h4>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3" style="display:none;">
                                                    ...
                                                    ID</label>
                                                    <input type="text" class="form-control" name="chart_id" id="chart_id"
                                                    readonly="readonly"
                                                    value='<?php echo $row['chart_id']; ?>' />
                                            </div>
                                            ...
                                            <div class="mb-3" style="display:none;">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            class='bx bx-home-heart'></i></span>

                                                            <input type="text" class="form-control" name="sto_name"
                                                            id="sto_name" readonly="readonly"
                                                            value='<?php echo $_SESSION['akksofttechsess_stoname'];?>' />
                                                ...
                                                <div class="col-sm-10"> 
                                                    <div class="show_view_img"><center><img src="../getimg/plan/<?php echo $row['chart_name']; ?>" width="80%;"></center></div>
                                                    ...
                                                    style="display:none;" ><?php echo $row['chart_name']; ?></textarea>
