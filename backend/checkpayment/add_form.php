                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <p class="card-text">
                                                                            ...
                                                                            <label class="form-subhead1">FORM :
                                                                                
                                                                                <label class="form-input3"><i class="bx bxs-user"></i> <?php echo $rowpay['bac_account'];?></label> |
                                                                                <label
                                                                                class="form-input3"><i class="bx bx-copy"></i> <?php echo $rowpay['bac_number'];?></label> ( <label
                                                                                class="form-input3"> <?php echo $rowpay['bac_name'];?></label> )
                                                                            
                                                                            <br>  
                                                                            <label class="form-subhead1">TO :
                                                                                <label class="form-input3"><i class="bx bxs-user"></i> <?php echo $rowpay['bac_mem_name'];?></label> | 
                                                                               
                                                                               <label class="form-input3"><i class="bx bx-copy"></i> <?php echo $rowpay['bac_number_mem'];?></label> ( <label class="form-input3"> <?php echo $rowpay['bac_sto_name'];?></label> )
                                                                            <br>
