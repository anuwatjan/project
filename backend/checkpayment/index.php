                ...
                <div class="col">
                  <div class="card mb-4">
                    ...
                    <?php
                      ...
                      WHERE sto_id = '".$_SESSION['akksofttechsess_stoid']."' AND po_status = 2 OR po_status = 7 " ;
