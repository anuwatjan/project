                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                <li class="nav-item">
                                    <a type=" button" class="btn btn-primary" id="btn-view" href="index.php"><i
                                                ...
                                                <div class="mb-3" style="display:none;">
                                                    ...
                                                    <label class="col-sm-2 col-form-label"
                                                        ...
                                                        <div class="col-sm-4">
                                                         ...
                                                         <select name="scate_id" id="scate_id" class='form-select' required>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                        <textarea type="text" class="form-control" name="prod_detail"
                                                                id="prod_detail" placeholder=""
                                                                
                                                                ><?php echo $row['prod_detail'];?></textarea>
...
$(document).ready(function() {
        $("#cat_id").change(function() { //
            ...
            $.ajax({
                url: "view_sub_cat.php", //ทำงานกับไฟล์นี้
                data: "cat_id=" + $("#cat_id").val(), //ส่งตัวแปร
                type: "POST",
                async: false,
