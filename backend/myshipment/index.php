...
<body>
      ...
      <div class="layout-container">
         ...
         <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
               <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">PREPARING FOOD</span></h4>
               <div class="row">
                  <div class="col-md-12">
                ...
                <div class="col">
                  <div class="card mb-4">
                    ...
                    <?php
                      ...
                      WHERE sto_id = '".$_SESSION['akksofttechsess_stoid']."' AND po_status = 3"  ;
                    ...
                    <?php
                                    ...
                                    <td style="text-align:center;">
                                      ...
                                      <?php }   ?>
                                       ...
                                       <td style="text-align:center;"><?php echo number_format($totoprice,2,'.',','); ?></td>
                                       
                                       <td style="text-align:center;">
                                        <?php 
                                        
                                        if($row['po_status'] == 3 &&  $rowpay['pay_cus_id'] == 0){
                                      ...
                                      <td style="text-align:center;">
                                        ...
                                        <a type="button" href="#" id="<?php echo $row['po_id']; ?>" class="btn btn-outline-warning toship">CONFIRM PREPARING FOOD</a>
   ...
   <script type="text/javascript" src="toship.js"></script>
