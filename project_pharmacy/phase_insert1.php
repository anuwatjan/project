...
<form method="POST" action="?page=phase&function=insert&act=update">
    <div class="row">
        ...
        <!-- Modal -->
        <div class="modal fade showmodaldetail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php
                            $strSQL = "SELECT * FROM product where product_status = 0 ";
                      ...
                      ?>
                                <tr>
                                    <td><?php echo $objResult["product_name"];?></td>
                                      <td class="text-center"><?php echo $objResult["product_suppiles"];?>
