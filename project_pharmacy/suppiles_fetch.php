...
$columns = array('suppiles_name', 'suppiles_company','suppiles_phone','suppiles_address','suppiles_email','description');
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<div contenteditable class="update" data-suppiles_id="'.$row["suppiles_id"].'" data-column="suppiles_address">' . $row["suppiles_address"] . '</div>';
 ...
 $sub_array[] = '<button type="button "  name="delete" class="delete btn btn-danger btn-sm" style="border:none;" suppiles_id="'.$row["suppiles_id"].'">ลบ</button>';
 $data[] = $sub_array; 
}
