...
<center>
    <h3>รายงานสรุปยอดขายแบบรายปี</h3>
</center>
<br>
<br>
<br>
...
$sql = ("SELECT DATE_FORMAT(sales_date, '%Y') AS sales_date, #เปลี่ยนฟอแมตวันที่จาก ป-ด-ว ให้เป็น ด-ป
                                                    ...
                                                    FROM sales 
													GROUP BY DATE_FORMAT(sales_date, '%Y') #จัดกลุ่มข้อมูลจาก ด-ป
													ORDER BY DATE_FORMAT(sales_date, '%Y') DESC #เรียงลำดับข้อมูลจากมากไปน้อย
													");
...
?>
    ...
    <div class="panel panel-back noti-box">
        <div class="text-box">
            <p class="main-text">ยอดขายสินค้าแต่ละปี</p>
            <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <?php
    $connect = mysqli_connect("localhost","root","akom2006","project_new");
    $sql22 = "SELECT * , year(a.sales_date) as year , SUM(product_total) as amount FROM sales a GROUP BY year";
