                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link">หน้าหลัก</a>
                                                </li>
                                                <li class="nav-item"><a href="#" class="nav-link">ข้อมูลส่วนตัว</a>
                                                </li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">หน้าหลัก <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">หน้าหลัก</a> <span class="bread-slash"></span>
                                            </li>
